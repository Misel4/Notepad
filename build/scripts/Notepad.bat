...
set CLASSPATH=%APP_HOME%\lib\Notepad.jar;%APP_HOME%\lib\annotations.jar;%APP_HOME%\lib\mysql-connector-java-8.0.11.jar;%APP_HOME%\lib\protobuf-java-2.6.0.jar

@rem Execute Notepad
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %NOTEPAD_OPTS%  -classpath "%CLASSPATH%" Main %CMD_LINE_ARGS%
